...
// GetOutFormat returns the OutFormat field value
...
// GetOutFormatOk returns a tuple with the OutFormat field value
// and a boolean to check if the value has been set.
func (o *CsvFileRequest) GetOutFormatOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.OutFormat, true
}

// SetOutFormat sets field value
...
func (o CsvFileRequest) ToMap() (map[string]interface{}, error) {
	...
	toSerialize["outFormat"] = o.OutFormat
