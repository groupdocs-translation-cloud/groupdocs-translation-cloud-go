...
// checks if the OcrFileRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OcrFileRequest{}

// OcrFileRequest struct for OcrFileRequest
...
func (o *OcrFileRequest) SetFileNil() {
	o.File.Set(nil)
}
...
func (o *OcrFileRequest) SetOriginalFileNameNil() {
...
func (o *OcrFileRequest) SetUrlNil() {
	o.Url.Set(nil)
}
...
func (o *OcrFileRequest) SetOriginNil() {
	o.Origin.Set(nil)
}
...
func (o *OcrFileRequest) SetRouteNil() {
	o.Route.Set(nil)
}
...
func (o OcrFileRequest) MarshalJSON() ([]byte, error) {
...
func (o OcrFileRequest) ToMap() (map[string]interface{}, error) {
...
type NullableOcrFileRequest struct {
	value *OcrFileRequest
	isSet bool
}

func (v NullableOcrFileRequest) Get() *OcrFileRequest {
	return v.value
}

func (v *NullableOcrFileRequest) Set(val *OcrFileRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableOcrFileRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableOcrFileRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOcrFileRequest(val *OcrFileRequest) *NullableOcrFileRequest {
	return &NullableOcrFileRequest{value: val, isSet: true}
}

func (v NullableOcrFileRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOcrFileRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
