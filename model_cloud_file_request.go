...
// GetSummarized returns the Summarized field value if set, zero value otherwise.
func (o *CloudFileRequest) GetSummarized() bool {
	if o == nil || IsNil(o.Summarized) {
		var ret bool
		return ret
	}
	return *o.Summarized
...
// GetSummarizedOk returns a tuple with the Summarized field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *CloudFileRequest) GetSummarizedOk() (*bool, bool) {
	if o == nil || IsNil(o.Summarized) {
		return nil, false
	}
	return o.Summarized, true
}
...
// SetSummarized gets a reference to the given bool and assigns it to the Summarized field.
...
func (o CloudFileRequest) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.Summarized) {
		toSerialize["summarized"] = o.Summarized
	}
	if o.Url.IsSet() {
