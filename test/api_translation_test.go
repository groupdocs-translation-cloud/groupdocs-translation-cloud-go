...
import (
	...
	// "io/ioutil"
	"testing"
	// groupdocs_translation_api "github.com/groupdocs-translation-cloud/groupdocs-translation-cloud-go"
)

func Test_groupdocs_translation_api_TranslationApiService(t *testing.T) {

	// clientId := ConfigClientID
	// clientSecret := ConfigClientSecret
	// configuration := groupdocs_translation_api.NewConfiguration(clientId, clientSecret)
	// apiClient := groupdocs_translation_api.NewAPIClient(configuration)

	t.Run("Test TranslationApiService", func(t *testing.T) {
